...
public sealed class Definitions : IDisposable
{
    ...
    private void Customize(ActionDefinitions d)
    {
        ...
        d.Spell(AID.Lustrate)!.ForbidExecute =
        d.Spell(AID.Indomitability)!.ForbidExecute =
        d.Spell(AID.Excogitation)!.ForbidExecute =
        d.Spell(AID.EnergyDrain)!.ForbidExecute =
            (ws, _, _, _) => ws.Client.GetGauge<ScholarGauge>().Aetherflow == 0;
