...
public sealed class Definitions : IDisposable
{
    public Definitions(ActionDefinitions d)
    {
        ...
        d.RegisterSpell(AID.DoubleCheck, true, maxCharges: 3);
        d.RegisterSpell(AID.Checkmate, true, maxCharges: 3);
        d.RegisterSpell(AID.Excavator, true);
        d.RegisterSpell(AID.FullMetalField, true);
