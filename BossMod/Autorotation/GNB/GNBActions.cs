...
class Actions : TankActions
{
    ...
    private void OnConfigModified(GNBConfig config)
    {
        ...
        // smart targets
        SupportedSpell(AID.HeartOfCorundum).TransformTarget = SupportedSpell(AID.HeartOfStone).TransformTarget = config.SmartHeartofCorundumShirkTarget ? SmartTargetFriendlyOrSelf : null;
