...
namespace BossMod
{
    ...
    public static class CommonDefinitions
    {
        ...
        public static ActionDefinition OGCDCast<AID, CDGroup>(this Dictionary<ActionID, ActionDefinition> res, AID aid, float range, float castTime, CDGroup cdGroup, float cooldown, float animationLock = 0.6f) where AID : Enum where CDGroup : Enum
