...
namespace BossMod
{
    ...
    public static class CommonDefinitions
    {
        ...
        public static ActionDefinition OGCDCast<AID, CDGroup>(this Dictionary<ActionID, ActionDefinition> res, AID aid, float range, float cooldown, CDGroup cdGroup, float castTime, float animationLock = 0.1f) where AID : Enum where CDGroup : Enum
