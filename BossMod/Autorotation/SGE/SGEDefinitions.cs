...
namespace BossMod.SGE
{
    ...
    public static class Definitions
    {
        ...
        static Definitions()
        {
            ...
            SupportedActions.OGCD(AID.Physis, 0, CDGroup.Physis, 60.0f);
            ...
            SupportedActions.OGCD(AID.Soteria, 0, CDGroup.Soteria, 90.0f);
            ...
            SupportedActions.OGCD(AID.Kerachole, 0, CDGroup.Kerachole, 30.0f);
            SupportedActions.OGCD(AID.Ixochole, 0, CDGroup.Ixochole, 30.0f);
            SupportedActions.OGCD(AID.Zoe, 0, CDGroup.Zoe, 120.0f);
            SupportedActions.OGCD(AID.Pepsis, 0, CDGroup.Pepsis, 30.0f);
            SupportedActions.OGCD(AID.PhysisII, 0, CDGroup.PhysisII, 60.0f);
            SupportedActions.OGCD(AID.Taurochole, 30, CDGroup.Taurochole, 45.0f);
            SupportedActions.GCD(AID.Toxikon, 25);
            SupportedActions.OGCD(AID.Haima, 30, CDGroup.Haima, 120.0f);
            ...
            SupportedActions.OGCD(AID.Holos, 0, CDGroup.Holos, 120.0f);
            SupportedActions.OGCD(AID.Panhaima, 0, CDGroup.Panhaima, 120.0f);
            ...
            SupportedActions.OGCD(AID.Krasis, 30, CDGroup.Krasis, 60.0f);
