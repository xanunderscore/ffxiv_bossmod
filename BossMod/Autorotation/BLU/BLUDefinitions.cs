...
namespace BossMod.BLU
{
    ...
    public static class Definitions
    {
        ...
        static Definitions()
        {
            ...
            SupportedActions.OGCDCast(AID.TheRoseOfDestruction, 25, 30.0f, CDGroup.TheRoseOfDestruction, 2.0f);
            SupportedActions.GCD(AID.DivineCataract, 0);
            SupportedActions.OGCDCast(AID.ChelonianGate, 0, 30.0f, CDGroup.TheRoseOfDestruction, 2.0f);
            SupportedActions.OGCDCast(AID.AngelsSnack, 0, 120.0f, CDGroup.AngelsSnack, 2.0f);
            ...
            SupportedActions.OGCDCast(AID.ColdFog, 0, 90.0f, CDGroup.ColdFog, 2.0f);
            SupportedActions.GCDCast(AID.TatamiGaeshi, 20, 2.0f);
            SupportedActions.GCDCast(AID.Tingle, 20, 2.0f);
            SupportedActions.OGCDCast(AID.TripleTrident, 3, 90.0f, CDGroup.TripleTrident, 2.0f);
            ...
            SupportedActions.OGCDCast(AID.Devour, 3, 60.0f, CDGroup.Devour, 1.0f);
            SupportedActions.GCDCast(AID.Reflux, 25, 2.0f);
            SupportedActions.GCDCast(AID.Exuviation, 0, 2.0f);
            SupportedActions.OGCDCast(AID.AngelWhisper, 25, 300.0f, CDGroup.AngelWhisper, 10.0f);
            ...
            SupportedActions.OGCDCast(AID.Level5Death, 0, 180.0f, CDGroup.Level5Death, 2.0f);
            ...
            SupportedActions.OGCDCast(AID.Ultravibration, 0, 120.0f, CDGroup.Level5Death, 2.0f);
            ...
            SupportedActions.OGCDCast(AID.CandyCane, 25, 90.0f, CDGroup.CandyCane, 1.0f);
            SupportedActions.GCDCast(AID.LaserEye, 25, 2.0f);
            SupportedActions.OGCDCast(AID.WingedReprobation, 25, 90.0f, CDGroup.WingedReprobation, 1.0f);
            SupportedActions.OGCDCast(AID.ForceField, 0, 120.0f, CDGroup.ForceField, 2.0f);
            ...
            SupportedActions.OGCDCast(AID.RubyDynamics, 0, 30.0f, CDGroup.TheRoseOfDestruction, 2.0f);
            ...
            SupportedActions.OGCDCast(AID.MatraMagic, 25, 120.0f, CDGroup.AngelsSnack, 2.0f);
            ...
            SupportedActions.OGCDCast(AID.DragonForce, 0, 120.0f, CDGroup.AngelsSnack, 2.0f);
            ...
            SupportedActions.OGCDCast(AID.OffGuard, 25, 60.0f, CDGroup.OffGuard, 1.0f);
            SupportedActions.GCDCast(AID.Level5Petrify, 0, 2.0f);
            SupportedActions.OGCDCast(AID.Avail, 10, 120.0f, CDGroup.Avail, 1.0f);
            SupportedActions.OGCDCast(AID.MagicHammer, 25, 90.0f, CDGroup.CandyCane, 1.0f);
            ...
            SupportedActions.OGCDCast(AID.PeculiarLight, 0, 60.0f, CDGroup.OffGuard, 1.0f);
