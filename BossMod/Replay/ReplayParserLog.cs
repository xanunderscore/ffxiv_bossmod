...
public sealed class ReplayParserLog : IDisposable
{
    ...
    private PartyState.OpModify ParsePartyModify() => new(_input.ReadInt(), new(_input.ReadULong(true), _input.ReadULong(true), _version >= 15 && _input.ReadBool(), _version < 15 ? "" : _input.ReadString(), _version >= 22 && _input.ReadBool()));
    private PartyState.OpModify ParsePartyLeave() => new(_input.ReadInt(), new(0, 0, false, "", false));
