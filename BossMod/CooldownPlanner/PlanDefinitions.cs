...
public static class PlanDefinitions
{
    ...
    private static ClassData DefinePLD()
    {
        ...
        c.CooldownTracks.Add(new("Bulwark", ActionID.MakeSpell(PLD.AID.Bulwark), 52));
        ...
        c.CooldownTracks.Add(new("Intervention", ActionID.MakeSpell(PLD.AID.Intervention), 62));
        c.CooldownTracks.Add(new("Cover", ActionID.MakeSpell(PLD.AID.Cover), 45));
        c.CooldownTracks.Add(new("Passage", ActionID.MakeSpell(PLD.AID.PassageOfArms), 70));
        ...
        c.CooldownTracks.Add(new("Veil", ActionID.MakeSpell(PLD.AID.DivineVeil), 56));
        ...
        c.CooldownTracks.Add(new("Sprint", CommonDefinitions.IDSprint, 1));
        c.StrategyTracks.Add(new("FoF", typeof(CommonRotation.Strategy.OffensiveAbilityUse)));
        c.StrategyTracks.Add(new("Requiescat", typeof(CommonRotation.Strategy.OffensiveAbilityUse)));
        return c;
    }
